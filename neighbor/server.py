...
class MemoryMappedOptimizedServer:
    ...
    def _load_data(self):
        ...
        print(f"  邻居数据: {self.neighbor_shares.shape}")
        print(f"  数据大小: {self.neighbor_shares.nbytes / 1024 / 1024:.1f}MB")
        ...
        for process_id in range(self.vdpf_processes):
            ...
            if start_batch < num_batches:
                args = (
                    ...
                    serialized_key,
                    self.server_id,
                    self.neighbors_path,  # 传递邻居数据文件路径
    ...
    def _handle_vector_node_query(self, request: Dict) -> Dict:
        ...
        try:
            ...
            vector_dim = self.neighbor_shares.shape[1]  # 动态获取向量维度（邻居列表长度）
