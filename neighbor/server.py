...
class MemoryMappedOptimizedServer:
    ...
    def _load_data(self):
        ...
        print(f"  [CN]: {self.neighbor_shares.shape}")
        print(f"  [CN]: {self.neighbor_shares.nbytes / 1024 / 1024:.1f}MB")
    ...
    def _handle_vector_node_query(self, request: Dict) -> Dict:
        ...
        try:
            ...
            vector_dim = self.neighbor_shares.shape[1]  # [CN]Vector dimension（[CN]）
