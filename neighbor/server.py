...
def evaluate_batch_range_process(args):
    ...
    process_id, start_batch, end_batch, cache_batch_size, num_nodes, serialized_key, server_id, data_shares_path, dataset_name = args
    ...
    data_shares = np.load(data_shares_path)
    ...
    for batch_idx in range(start_batch, end_batch):
        ...
        batch_data = data_shares[batch_start:batch_end].copy()
...
class MemoryMappedOptimizedServer:
    ...
    def __init__(self, server_id: int, dataset: str = "laion", vdpf_processes: int = 4):
        ...
        # Exchange directory (fallback to standard file system)
    ...
    def _load_data(self):
        ...
        print(f"  Neighbor data: {self.neighbor_shares.shape}")
        print(f"  Data size: {self.neighbor_shares.nbytes / 1024 / 1024:.1f}MB")
        ...
        for process_id in range(self.vdpf_processes):
            ...
            if start_batch < num_batches:
                args = (
                    ...
                    serialized_key,
                    self.server_id,
                    self.neighbors_path,  # Pass neighbor data file path
    ...
    def _handle_vector_node_query(self, request: Dict) -> Dict:
        ...
        try:
            ...
            # Use neighbor data instead of node data
            num_nodes = len(self.neighbor_shares)
            vector_dim = self.neighbor_shares.shape[1]  # Dynamically get vector dimension (neighbor list length)
            ...
            # 3. Phase 1: Multiprocess VDPF evaluation (maintain original implementation)
            ...
            # 5. Phase 3: Simulate batch exchange (maintain uncompressed optimization)
