...
SERVERS = {
    1: {
        ...
        "private_host": "10.0.1.101",   # 服务器间通信用的私网IP（需要在server1上检查）
        "port": 8001
    },
    2: {
        "public_host": "192.168.1.102",    # 客户端连接用的公网IP
        "private_host": "10.0.1.102",   # 服务器间通信用的私网IP（需要在server2上检查）
        "port": 8002
    },
    3: {
        "public_host": "192.168.1.103",  # 客户端连接用的公网IP
        "private_host": "10.0.1.103",    # 服务器间通信用的私网IP（需要在server3上检查）
        "port": 8003
    }
}
